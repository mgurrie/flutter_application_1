                ...
                child: Wrap(
                  ...
                  children: [
                    _buildBadge('4194 points', Icons.stars, 0.9,
                        color: Colors.yellow),
                    _buildBadge('4 days', Icons.flash_on, 0.6,
                        color: Colors.red),
                    _buildBadge('12 tasks', Icons.check, 0.8,
                        color: Colors.green),
                    _buildBadge('6 goals', Icons.star, 0.5,
                        color: Colors.purple),
                  ],
                ),
              ),
                ...
                child: Wrap(
                  ...
                  children: [
                    ...
                    _buildBadge('2 courses', Icons.book, 0.9,
                        color: Colors.blue),
                    _buildBadge('30 tasks', Icons.check_circle, 0.7,
                        color: Colors.green),
                    _buildBadge('3 goals', Icons.star, 0.4,
                        color: Colors.yellow),
                    _buildBadge('5 videos', Icons.video_call, 0.5,
                        color: Colors.red),
                    _buildBadge('2 awards', Icons.emoji_events, 0.3,
                        color: Colors.orange),
                  ],
                ),
              ),
